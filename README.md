...
#### 高阶玩法
+ 使用python脚本解析订阅链接，自动生成改配置文件，需要你在 Python 代码中设置好你的订阅链接，代码见：[generate_config_quickly](https://github.com/zhanyeye/clash-rules-lite/blob/master/generate_config_quickly.py)
